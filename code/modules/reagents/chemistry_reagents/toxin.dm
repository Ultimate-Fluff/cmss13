...
/datum/reagent/toxin/potassium_phorosulfate
	...
	description = "A chemical made from a violent reaction using sulfuric acid. Has specific industrial uses in sterilizing surfaces from biological contamination in non human accessible ares. Not used in other areas due to its long lasting corrosive effects unless treated."
	reagent_state = SOLID
	color = COLOR_WHITE
	overdose = 10
	chemclass = CHEM_CLASS_RARE
