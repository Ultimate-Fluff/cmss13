...
/datum/poster/poster_50
	...
	desc = "An ominous forward facing profile of the Synthetic model 'Daniel'. Not quite a second generation model but something grass_seed suited for the needs of colonists. The poster is more art then an advertisement."
...
/datum/poster/poster_91
	...
	desc = "A stylized depiction of the UPP's flag and the words, 'Our Unity is the dream of all Peoples. Trust in the strength of their Union.'"
